...
public class HardeningAnalysis {

	final static Logger logger = LogManager.getLogger(HardeningAnalysis.class);
	
	private AndOrGraph graph;
	private LineAndOrGraph lineGraph;
	private MaxSatSolution solution; 
	
	public HardeningAnalysis(AndOrGraph graph) {
		this.graph = graph;
		this.lineGraph = null;
		this.solution = null;
	}
	...
	public MaxSatSolution getSolution() {
		return solution;
	}

	public LineAndOrGraph getLineGraph() {
		return lineGraph;
	}
